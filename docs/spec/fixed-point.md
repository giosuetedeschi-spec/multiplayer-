...
| `PI` | `0x0000_0003_243F_6A88` | 3.14159265358... |
| `TAU` | `0x0000_0006_487E_D511` | 6.28318530717... |
| `FRAC_PI_2` | `0x0000_0001_921F_B544` | 1.57079632679... |
| `INV_TAU` | `0x0000_0000_28BE_60DB` | 0.15915494309... |
| `E` | `0x0000_0002_B7E1_5162` | 2.71828182845... |
...
`cargo run -p tempo-fixed --bin gentables`.
...
Table `ATAN_TABLE`: **1025** `i64` entries where entry `i` is
`round_half_away_from_zero(atan(i / 1024) · 2^32)`, covering the ratio range `[0, 1]`.
...
exp(a) = exp2(mul(a, LOG2_E))    // LOG2_E = 1/ln(2), raw 0x0000_0001_7154_7652
ln(a)  = mul(log2(a), LN_2)      // LN_2  = ln(2),    raw 0x0000_0000_B172_17F7
